...
insert into `user` values (1, '管理员', '123456789', '13169703137@163.com', 'SJTU', 'http://img3m7.ddimg.cn/48/0/24106647-1_w_6.jpg', '123456789', 0, 0, 0, '我是管理员！', 0);
insert into `user` values (2, 'ILoLy', '15017640364', 'iloly10@sjtu.edu.cn', 'SJTU-X12', 'https://i.postimg.cc/Bvz2Tsbp/zyc.jpg', '3440233385', 0, 0, 0, '我是用户zyc！', 2);
insert into `user` values (3, '高治铭', '12345678', 'gzm@sjtu.edu.cn', 'SJTU-D18', 'https://i.postimg.cc/YS01Ljrj/gzm.jpg', '2643917629', 0, 0, 0, '我是用户gzm！', 0);
insert into `user` values (4, '伟大的臧斌宇', '021-34207408', 'byzang@sjtu.edu.cn', '软件学院1312室', 'https://i.postimg.cc/3RpsCSL4/image.png', '123456789', 0, 0, 0, '我是软件学院院长臧斌宇！', 0);
insert into `user` values (5, '英俊的陈榕', '021-34204789', 'rongchen@sjtu.eud.cn', '软件学院3402室', 'https://i.postimg.cc/cCSVDRjD/image.jpg', '123456789', 0, 0, 0, '我是软件学院教授陈榕！', 0);
insert into `user` values (6, '苗条的陈昊鹏', '021-34204124', 'chen-hp@sjtu.edu.cn', '软件学院1111室', 'https://i.postimg.cc/7Lpvz8Nr/image.jpg', '123456789', 0, 0, 0, '我是软件学院副教授陈昊鹏！', 0);
...
create table `chat` (
    ...
    `sender_flag` int not null default 0,
    `receiver_flag` int not null default 0,
    primary key (`chat_id`),
    foreign key (`sender`) references `user_auth` (`user_id`),
    foreign key (`receiver`) references `user_auth` (`user_id`)
) engine=InnoDB default charset=utf8;
insert into `chat` values (1, 2, 3, 1, 0);
insert into `chat` values (2, 1, 2, 0, 1);
...
insert into `chat_info` values (5, 1, 3, 2, '我想买《大王子》', '2023-4-20 09:40:00.00');
...
insert into `liked` values (1, 2, '图书', 10);